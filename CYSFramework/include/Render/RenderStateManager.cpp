...
void CRenderStateManager::SetSampleMask(const std::string& Name, UINT Mask)
{
	CBlendState* State = (CBlendState*)FindState(Name);
...
void CRenderStateManager::AddBlendDesc(const std::string& Name, bool Enable, D3D11_BLEND Src, D3D11_BLEND Dest, D3D11_BLEND_OP BlendOp, D3D11_BLEND SrcAlpha, D3D11_BLEND DestAlpha, D3D11_BLEND_OP AlphaOp, UINT8 RenderTargetWriteMask)
{
	CBlendState* State = (CBlendState*)FindState(Name);
