...
{
	// Factory 만들기
	if (FAILED(DWriteCreateFactory(DWRITE_FACTORY_TYPE_SHARED, __uuidof(mWriteFactory), (IUnknown**)&mWriteFactory)))
	{
		return false;
	}
	...
	CreateFontColor(255, 0, 0, 255);			// 빨강
	CreateFontColor(0, 255, 0, 255);			// 초록
	CreateFontColor(0, 0, 255, 255);			// 파랑
